...
# New type is the column name which indicates sample type (we already have sample type but we change SARS-Cov2 to pneumonia in the new type and hence the new column)
...
# Calculate mean score per histopathology feature per group
...
# Figure 2A
# Comparing all pneumonias to vs SARS-CoV2 pneumonias
...
# I can directly use cor(df) but doing a loop to make insig values 0 for the figure. 
...
fname<-paste0("figures/Correlation/pneumonia_only_updated_HE_feature_correlation.tiff")
ggsave(p2,filename = fname, width = 30, height =30,units="in", dpi=300)

fname2<-paste0("figures/Correlation/pneumonia_only_updated_HE_feature_correlation.pdf")
ggsave(p2,filename = fname2, width = 30, height =30,units="in", dpi=300)
 print(p2) 
```

# Comparing histopathology features across Bacterial present/absent in the lung
...
# Checking how many samples have vibisble bacteria in the lung and a positive SARS-CoV2 test - 4 samples 
...
ggsave(p,filename = "figures/Correlation/HE_vs_mIHC_corr_test_results.tiff", width = 12, height = 20, scale=0.8,units="in", dpi=300)
ggsave(p,filename = "figures/Correlation/HE_vs_mIHC_corr_test_results.pdf", width = 12, height = 20, scale=0.8,units="in", dpi=300)
...
ggsave(mouse_by_cluster,filename ="figures/Supplemental_figures/mouse_type_by_clusters.pdf",width = 12,height =12,dpi = 300) 

ggsave(mouse_by_cluster,filename ="figures/Supplemental_figures/mouse_type_by_clusters.tiff",width = 12,height =12,dpi = 300) 
```
...
# Heatmap of combined clustering
